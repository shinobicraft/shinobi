...
client.on('message', msg => {  //WESO#0001
  ...
  client.on("message", message => {  //! 𝔻𝕍 |☬ elghichem_gamez#8832
    if(message.content.startsWith(prefix + 'v2min')) {  //! 𝔻𝕍 |☬ elghichem_gamez#8832
     let args = message.content.split(" ").slice(1);  //! 𝔻𝕍 |☬ elghichem_gamez#8832
       var nam = args.join(' ');
    
      if(!message.member.hasPermission('ADMINISTRATOR')) return    message.channel.send('`ADMINISTRATOR` للأسف هذه الخاصية تحتاج الى ').then(msg => msg.delete(6000))
      if (!nam) return message.channel.send(`<@${message.author.id}> يجب عليك ادخال اسم`).then(msg => msg.delete(10000))  //! 𝔻𝕍 |☬ elghichem_gamez#8832
      message.guild.createChannel(nam, 'voice').then(c => setTimeout(() => c.delete(), 120000))   //! 𝔻𝕍 |☬ elghichem_gamez#8832
...
client.on("message", message => {    //! 𝔻𝕍 |☬ elghichem_gamez#8832
    if(message.content.startsWith(prefix + "emoji")) {   //! 𝔻𝕍 |☬ elghichem_gamez#8832
        if(message.author.bot) return;  //! 𝔻𝕍 |☬ elghichem_gamez#8832
        var emojiid =  message.content.split(" ").slice(1).join(" ")   //! 𝔻𝕍 |☬ elghichem_gamez#8832
        console.log(emojiid) 
        if(emojiid.length < "18" || emojiid.length > "18" || isNaN(emojiid)) return  message.channel.send(`- Usage  //WESO#0001
${prefix}emoji <EmojiID>`); 
        else    
        message.channel.send("This is the emoji that you requested:-",  //! 𝔻𝕍 |☬ elghichem_gamez#8832
          { 
            files: [`https://cdn.discordapp.com/emojis/${emojiid}.png`]  //! 𝔻𝕍 |☬ elghichem_gamez#8832
          }) 
        }  
})   
 ...
 client.on("message", message => {  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  if (message.channel.type === "dm") {    //! 𝔻𝕍 |☬ elghichem_gamez#8832

      message.channel.startTyping();    //! 𝔻𝕍 |☬ elghichem_gamez#8832
      setTimeout(() => {    //! 𝔻𝕍 |☬ elghichem_gamez#8832
        message.channel.stopTyping();    //! 𝔻𝕍 |☬ elghichem_gamez#8832
      }, Math.random() * (1 - 3) + 1 * 1000);  //! 𝔻𝕍 |☬ elghichem_gamez#8832
   
  }  
});  

const clans = {};  //! 𝔻𝕍 |☬ elghichem_gamez#8832
const system = {};  // ! 𝔻𝕍 |☬ elghichem_gamez#8832
const level = {};  //! 𝔻𝕍 |☬ elghichem_gamez#8832
 
 
client.on('message',async message => {  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  if(message.author.bot) return;  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  if(message.channel.type === 'dm') return;  //! 𝔻𝕍 |☬ elghichem_gamez#8832
 
  let args = message.content.split(' ');  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  let random = Math.floor(Math.random() * 5) + 2;  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  let author = message.author;
 
  let xpLeft;  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  let nameClan;  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  let membersClan = [];  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  let levelClan = 0;  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  if(!system[author.id]) system[author.id] = {clan: 'None',joinedAt: new Date().toLocaleString() ,clanLevel: 0};  //! 𝔻𝕍 |☬ elghichem_gamez#8832
 
  if(!level[author.id]) level[author.id] = {level: 1, xp: 1};  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  ...
  if(message.content.startsWith(prefix + "clan")) {  //! 𝔻𝕍 |☬ elghichem_gamez#8832
    if(message.content.split(' ')[0] !== `${prefix}clan`) return;  //! 𝔻𝕍 |☬ elghichem_gamez#8832
 
    if(!args[1] || args[1] && args[1] === 'info') {  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  let embed = new Discord.RichEmbed()
  .setAuthor('الكلانات', message.author.avatarURL)  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  ...
  .setFooter(message.author.username, message.author.avatarURL);  //! 𝔻𝕍 |☬ elghichem_gamez#8832
  message.channel.send(embed);
}
 
    if(args[1] && args[1] === 'create') {  //! 𝔻𝕍 |☬ elghichem_gamez#8832
      ...
      let awaited = await message.channel.awaitMessages(r => r.author.id === message.author.id, { max: 1, time: 20000, errors: ['time']}).then(collected => {
        ...
        nameClan = collected.first().content;  //! 𝔻𝕍 |☬ elghichem_gamez#8832
      });
 
      m = await m.edit('**# جارى عمل الكلان**');  //! 𝔻𝕍 |☬ elghichem_gamez#8832
      awaited = await setTimeout(async() => {  //! 𝔻𝕍 |☬ elghichem_gamez#8832
        let membersArray = {
          nameClan: {
            array: []
          }
        };
        let members = membersArray.nameClan.array;  //! 𝔻𝕍 |☬ elghichem_gamez#8832
        members.push(message.author.id);
        clans[nameClan] = {
          name: nameClan,
          createdAt: new Date().toLocaleString(),  //! 𝔻𝕍 |☬ elghichem_gamez#8832
          level: levelClan,
          creator: message.author.id,  //! 𝔻𝕍 |☬ elghichem_gamez#8832
          members: members,  //! 𝔻𝕍 |☬ elghichem_gamez#8832
          applylist: [],  //! 𝔻𝕍 |☬ elghichem_gamez#8832
          admins: []  //! 𝔻𝕍 |☬ elghichem_gamez#8832  //! 𝔻𝕍 |☬ elghichem_gamez#8832
        };
   ...
   //WESO#0001  //WESO#0001  //WESO#0001  //WESO#0001  //WESO#0001
    ...
    if(args[1] && args[1] === 'stats') {
      ...
      message.channel.send(embed);  //! 𝔻𝕍 |☬ elghichem_gamez#8832
